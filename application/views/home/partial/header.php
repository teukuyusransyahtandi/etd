<meta charset="utf-8">
  ...
  <link rel="apple-touch-icon" href="<?= base_url('assets/') ?>assets/images/apple-touch-icon.png">
  <link rel="shortcut icon" href="<?= base_url('assets/') ?>assets/images/favicon.ico">
  <!-- Stylesheets -->
  <link rel="stylesheet" href="<?= base_url('assets/') ?>global/css/bootstrap.min.css">
  <link rel="stylesheet" href="<?= base_url('assets/') ?>global/css/bootstrap-extend.min.css">
  <link rel="stylesheet" href="<?= base_url('assets/') ?>assets/css/site.min.css">
  <!-- Plugins -->
  ...
  <!--[if lt IE 10]>
    ...
    <![endif]-->
  <!-- Scripts -->
  <script src="<?= base_url('assets/') ?>global/vendor/modernizr/modernizr.js"></script>
